/*!
  ...
  * @license MIT
  */
var GrowthbunkerVueflags = (function (exports, vueDemi) {
  'use strict';
   ...
   */
  var Flag = vueDemi.defineComponent({
      props: {
          code: {
              type: String,
              required: true,
      ...
      setup(props, ctx) {
          ...
          if (vueDemi.isVue3) {
              vueFlags = vueDemi.inject("vueflags");
          }
          else {
              // @ts-ignore
              vueFlags = ctx.root.$vueflags;
          }
          // Get `src` for the component
          const src = vueDemi.computed(() => {
  ...
  const plugin = {
      install(app, options) {
          ...
          if (vueDemi.isVue3) {
              ...
              vueDemi.Vue2.prototype.$vueflags = options || {};
          }
      },
  };
